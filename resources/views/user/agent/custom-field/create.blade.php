...
<form id="custom_form" onsubmit="return validateForm()" method="post" enctype="multipart/form-data" action="{{ route('agent.custom-field.store') }}">
    ...
    @endphp
        ...
        <div class="col-sm-12 custom-field-group" id="image_fields" style="display: none;">
            <div class="mb-3">
                <label class="form-label cap-form-label">{{ get_phrase('Section Title') }}</label>
             <input type="text" name="image_custom_title" class="form-control cap-form-control {{ isset($customTitles['image']) ? 'alert alert-info' : '' }}" value="{{ $customTitles['image'] ?? '' }}" {{ isset($customTitles['image']) ? 'readonly' : '' }}>
                ...
                <div class="image-field-repeat rounded border p-3 mb-3">
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <label class="form-label cap-form-label">{{ get_phrase('Title') }}</label>
                        ...
                        <input type="text" name="image_title[]" class="form-control cap-form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label cap-form-label">{{ get_phrase('Description') }}</label>
                        <textarea name="image_description[]" class="form-control"></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label cap-form-label">{{ get_phrase('Image') }}</label>
                        <input type="file" name="image_file[]" class="form-control cap-form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 custom-field-group" id="text_fields" style="display: none;">
            <div class="mb-3">
                <label class="form-label cap-form-label">{{ get_phrase('Section Title') }}</label>
               <input type="text" name="text_custom_title" class="form-control cap-form-control {{ isset($customTitles['text']) ? 'alert alert-info' : '' }}" value="{{ $customTitles['text'] ?? '' }}" {{ isset($customTitles['text']) ? 'readonly' : '' }}>
            ...
            <div id="text_field_container">
                <div class="text-field-repeat rounded border p-3 mb-3">
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <label class="form-label cap-form-label">{{ get_phrase('Text Content') }}</label>
                            {{-- <div class="d-flex gap-2 mb-2">
                        ...
                        <textarea id="summernote" name="text_content[]" class="form-control cap-form-control"></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 custom-field-group" id="slider_fields" style="display: none;">
            <div class="mb-3">
                <label class="form-label cap-form-label">{{ get_phrase('Section Title') }}</label>
               <input type="text" name="slider_custom_title" class="form-control cap-form-control {{ isset($customTitles['slider']) ? 'alert alert-info' : '' }}"  value="{{ $customTitles['slider'] ?? '' }}" {{ isset($customTitles['slider']) ? 'readonly' : '' }}>
            </div>
            <div id="slider_field_container">
                <div class="slider-field-repeat rounded border p-3 mb-3">
                      <div class="mb-3">
                        ...
                        <input type="text" name="slider_title[]" class="form-control cap-form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label cap-form-label">{{ get_phrase('Description') }}</label>
                        <textarea name="slider_description[]" class="form-control cap-form-control"></textarea>
                    </div>
                    <div class="mb-3">
                         <label class="form-label cap-form-label">{{ get_phrase('Images') }}</label>
                        <input type="file" name="slider_images[]" multiple class="form-control cap-form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 custom-field-group" id="video_fields" style="display: none;">
            ...
            <div id="video_field_container">
                <div class="video-field-repeat rounded border p-3 mb-3">
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <label class="form-label cap-form-label">{{ get_phrase('Video URL') }}</label>
                        </div>
                        <input type="text" name="video_url[]" class="form-control cap-form-control" placeholder="https://youtube.com/...">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 custom-field-group" id="faq_fields" style="display: none;">
            <div class="mb-3">
                <label class="form-label cap-form-label">{{ get_phrase('Section Title') }}</label>
               <input type="text" name="faq_custom_title" class="form-control cap-form-control {{ isset($customTitles['faq']) ? 'alert alert-info' : '' }}"  value="{{ $customTitles['faq'] ?? '' }}" {{ isset($customTitles['faq']) ? 'readonly' : '' }}>
            </div>
            <div id="faq_field_container">
                <div class="faq-field-repeat rounded border p-3 mb-3">
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <label class="form-label cap-form-label">{{ get_phrase('FAQ Question') }}</label>
                            <div class="d-flex gap-2 mb-2">
                        ...
                        <input type="text" name="faq_question[]" class="form-control cap-form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label cap-form-label">{{ get_phrase('FAQ Answer') }}</label>
                        <textarea name="faq_answer[]" class="form-control cap-form-control"></textarea>
                    </div>
                </div>
            </div>
        </div>
           ...
           {{-- Gallery   FIELDS --}}
            <div class="col-sm-12 custom-field-group" id="gallery_fields" style="display: none;">
               <div class="mb-3">
                   <label class="form-label cap-form-label">{{ get_phrase('Section Title') }}</label>
                 <input type="text" name="gallery_custom_title" class="form-control cap-form-control {{ isset($customTitles['gallery']) ? 'alert alert-info' : '' }}"  value="{{ $customTitles['gallery'] ?? '' }}" {{ isset($customTitles['gallery']) ? 'readonly' : '' }}>
                </div>
                <div id="gallery_field_container">
                    <div class="gallery-field-repeat rounded border p-3 mb-3">
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <label class="form-label cap-form-label">{{ get_phrase('Gallery Image') }}</label>
                                <div class="d-flex gap-2 mb-2">
                            ...
                            <input type="file" name="gallery_images[]" multiple class="form-control cap-form-control">
                        </div>
                    </div>
                </div>
            </div>
...
function validateForm() {
    ...
    if (type === 'image') {
        ...
        document.querySelectorAll('.video-field-repeat').forEach((block, index) => {
            ...
            if (isEmpty(url)) {
                valid = false;
                errorMessage = 'Please provide a Video URLs.';
            }
        });
    } else if (type === 'faq') {
