...
<div class="sidebar-nav-area">
    <nav class="sidebar-nav">
        ...
        <ul class="px-14px pb-24px">
            ...
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/listings*') || request()->is('admin/listing-create') || request()->is('admin/listing-edit*') || request()->is('admin/listing-store*') || request()->is('admin/claimed-listings*') || request()->is('admin/claimed-history*') || request()->is('admin/reported-listings*')  ?'active':''}}">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li {{request()->is('admin/claimed-listings*') ?'active':''}}"><a href="{{ route('admin.claimed_listings')}}"> {{get_phrase('Varify Listing')}} </a></li>
