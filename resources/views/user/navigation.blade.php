            ...
            @if (check_subscription(user('id')))
                <div class="mb-3">
                    ...
                    <nav>
                        ...
                        {{-- BLOG JE SAKRIVEN (COMMENTED OUT) --}}
                        {{--
